...
const Step3PrimaryContact = () => {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <h2 className="text-2xl font-bold text-gray-900 mb-6">Step 3: Primary Contact Information</h2>
      <p className="text-sm text-gray-600 mb-6">
        This should be the main point of contact for daily operations and communications.
      </p>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        <div>
          ...
          <input
            ...
            placeholder="e.g., Pharmacy Manager, Director of Operations"
          />
          {errors.title && (
...
export default Step3PrimaryContact